	...
	public static void main(String[] args) {
		...
		case 1:
			...
			while (true) {
				...
				switch(op) {
				case 1:	
					JOptionPane.showMessageDialog(null, "Km por hora: " + c2.acelerar(10));
					break;
				case 2:
					JOptionPane.showMessageDialog(null, "Km por hora:" + c2.freiar(10));
					break;
				case 3:
					c2.ligar();
		...
		case 2:
			...
			//aqui exibira os dados do veiculo
			JOptionPane.showMessageDialog(null,"-----Informações da Moto-----\nMarca: "+m1.getMarca()+"\nModelo: " + m1.getModelo()+"\nCor: " + m1.getCor()+ "\nTipo: " + m1.getTipo() + "\nFabricante: "  + m1.getFabrica()+"\nQuantidade rodas: " + m1.getQtd_rodas()+"\nTipo de transmissao: "+ m1.getTransmissao());

			while (true) {
				int op = Integer.parseInt(JOptionPane.showInputDialog(null,"O que deseja fazer?\n1)Acelerar\n2)Freiar\n3)Ligar\n4)Desligar\nDigite Qualquer Numero para finalizar o programa"));
				switch(op) {
				case 1:	
					JOptionPane.showMessageDialog(null, "Km por hora: " + m1.acelerar(10));
					break;
				case 2:
					JOptionPane.showMessageDialog(null, "Km por hora:" + m1.freiar(10));
					break;
				case 3:
					m1.ligar();
					JOptionPane.showMessageDialog(null, "Estado do carro: Ligado");
		...
		case 3:
			...
			//aqui exibira os dados do veiculo
			JOptionPane.showMessageDialog(null,"-----Informações do Caminhão-----\nMarca: "+c3.getMarca()+"\nModelo: " + c3.getModelo()+"\nCor: " + c3.getCor()+ "\nTipo: " + c3.getTipo() + "\nFabricante: "  + c3.getFabrica()+"\nQuantidade rodas: " + c3.getQtd_rodas()+"\nTipo de transmissao: "+ c3.getTransmissao());

			while (true) {
				int op = Integer.parseInt(JOptionPane.showInputDialog(null,"O que deseja fazer?\n1)Acelerar\n2)Freiar\n3)Ligar\n4)Desligar\nDigite Qualquer Numero para finalizar o programa"));
				switch(op) {
					case 1:	
						JOptionPane.showMessageDialog(null, "Km por hora: " + c3.acelerar(10));
						break;
					case 2:
						JOptionPane.showMessageDialog(null, "Km por hora:" + c3.freiar(10));
						break;
					case 3:
						c3.ligar();
						JOptionPane.showMessageDialog(null, "Estado do carro: Ligado");
